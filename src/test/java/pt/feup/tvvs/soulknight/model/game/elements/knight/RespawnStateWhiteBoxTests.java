...
public class RespawnStateWhiteBoxTests {
    Knight knight;
    Scene scene;
    RespawnState state;
    ...
    @Test
    public void testNextStateDeathTimerZero() throws IOException {
    ...
    @Test
    public void testNextStateRespawnParticlesTriggered() throws IOException {
