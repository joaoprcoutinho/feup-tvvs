...
public class RespawnParticleWhiteBoxTest {
    private Scene scene;
    ...
    @Test
    void testApplyCollisionsCeiling() {
    ...
    @Test
    void testApplyCollisionsDownward() {
    ...
    @Test
    void testApplyCollisionsHorizontalLeft() {
    ...
    @Test
    void testApplyCollisionsHorizontalRight() {
