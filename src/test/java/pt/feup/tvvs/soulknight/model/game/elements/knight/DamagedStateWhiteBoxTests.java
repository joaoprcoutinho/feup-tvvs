...
public class DamagedStateWhiteBoxTests {
    Knight knight;
    Scene scene;
    DamagedState state;
    ...
    @Test
    public void testGetNextStateWhenNoHP() {
    ...
    @Test
    public void testNextStateTicksLessThan15() {
        when(scene.collideSpike()).thenReturn(false);
        when(knight.getHP()).thenReturn(10);
    ...
    @Test
    public void testNextStateWalking() {
        when(scene.collideSpike()).thenReturn(false);
        when(knight.getHP()).thenReturn(10);
        state.setTicks(15);
        when(knight.isOnGround()).thenReturn(true);
