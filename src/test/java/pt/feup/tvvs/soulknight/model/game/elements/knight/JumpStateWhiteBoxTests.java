...
public class JumpStateWhiteBoxTests {
    Knight knight;
    Scene scene;
    JumpState state;
    ...
    @Test
    public void testJumpCounterBelowTwo() {
        when(knight.getJumpCounter()).thenReturn(1);
    ...
    @Test
    public void testJumpCounterAtTwo() {
    ...
    @Test
    public void testUpdateVelocityNegativeLowFall() {
    ...
    @Test
    public void testUpdateVelocityNegativeFastFall() {
    ...
    @Test
    public void testGetNextStateStartFalling() {
        when(scene.collideSpike()).thenReturn(false);
    ...
    @Test
    public void testGetNextStateStayJumping() {
        when(scene.collideSpike()).thenReturn(false);
        when(knight.isOverMaxXVelocity()).thenReturn(false);
