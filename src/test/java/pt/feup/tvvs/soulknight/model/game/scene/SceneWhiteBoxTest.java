...
public class SceneWhiteBoxTest {
    private Scene scene;
    ...
    @Test
    void testCollisionOutsideScene() {
        Element[][] map = new Element[20][20];
        scene.setMap(map);
    ...
    @Test
    void testCollisionWithMapElement() {
        Element[][] map = new Element[20][20];
        map[0][0] = mock(Element.class);
        scene.setMap(map);
    ...
    @Test
    void testNoCollisionWithEmptyMap() {
        Element[][] map = new Element[20][20];
        scene.setMap(map);
    ...
    @Test
    void testIsAtEndPositionTrueAndFalse() {
    ...
    @Test
    void testGravityGetter() {
        assertEquals(0.25, scene.getGravity(), 0.001);
    }

    @Test
    void testCollisionFails_playerLeftOfEnemy() {
        Enemies enemy = mock(Enemies.class);
    ...
    @Test
    void testCollisionFails_playerRightOfEnemy() {
        Enemies enemy = mock(Enemies.class);
    ...
    @Test
    void testCollisionFails_playerAboveEnemy() {
        Enemies enemy = mock(Enemies.class);
    ...
    @Test
    void testCollisionFails_playerBelowEnemy() {
        Enemies enemy = mock(Enemies.class);
