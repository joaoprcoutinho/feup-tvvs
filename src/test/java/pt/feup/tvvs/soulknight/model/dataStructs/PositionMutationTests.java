...
public class PositionMutationTests {
    ...
    @Test
    public void getLeft_shouldDecrementX() {
        Position p = new Position(10.0, 20.0);
    ...
    @Test
    public void getLeft_shouldNotChangeY() {
        Position p = new Position(10.0, 20.0);
        Position left = p.getLeft();
    ...
    @Test
    public void getRight_shouldIncrementX() {
        Position p = new Position(10.0, 20.0);
    ...
    @Test
    public void getRight_shouldNotChangeY() {
        Position p = new Position(10.0, 20.0);
        Position right = p.getRight();
    ...
    @Test
    public void getUp_shouldDecrementY() {
        Position p = new Position(10.0, 20.0);
        Position up = p.getUp();
    ...
    @Test
    public void getUp_shouldNotChangeX() {
        Position p = new Position(10.0, 20.0);
        Position up = p.getUp();
    ...
    @Test
    public void getDown_shouldIncrementY() {
        Position p = new Position(10.0, 20.0);
    ...
    @Test
    public void getDown_shouldNotChangeX() {
        Position p = new Position(10.0, 20.0);
        Position down = p.getDown();
    ...
    @Test
    public void equals_shouldReturnFalseForNonPosition() {
        Position p = new Position(10.0, 20.0);
