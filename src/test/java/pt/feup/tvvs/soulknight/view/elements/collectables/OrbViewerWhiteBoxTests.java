...
public class OrbViewerWhiteBoxTests {
    ...
    @Test
    public void constructorLoadsAllSprites() throws IOException {
    ...
    @Test
    public void drawsHealthOrb() throws IOException {
    ...
    @Test
    public void drawsEnergyOrb() throws IOException {
        OrbViewer viewer = new OrbViewer(spriteLoader);
    ...
    @Test
    public void drawsSpeedOrb() throws IOException {
        OrbViewer viewer = new OrbViewer(spriteLoader);
    ...
    @Test
    public void throwsExceptionForInvalidCharacter() throws IOException {
        OrbViewer viewer = new OrbViewer(spriteLoader);
