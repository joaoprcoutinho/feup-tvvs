...
public class OptionViewerWhiteBoxTests {
    ...
    @Test
    public void testDrawToMainMenu() {
    ...
    @Test
    public void testDrawResolutionAutomatic() {
    ...
    @Test
    public void testDrawResolutionNotLast() {
        when(option.getType()).thenReturn(Option.Type.RESOLUTION);
    ...
    @Test
    public void testDrawResolutionLast() {
        when(option.getType()).thenReturn(Option.Type.RESOLUTION);
