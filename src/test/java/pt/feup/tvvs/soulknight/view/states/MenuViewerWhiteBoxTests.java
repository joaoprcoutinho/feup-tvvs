...
public class MenuViewerWhiteBoxTests {
    ...
    @Test
    public void testDrawSettings() throws IOException {
    ...
    @Test
    public void testDrawFirstOptionStartTime() throws IOException {
    ...
    @Test
    public void testDrawDuringAnimation() throws IOException {
        when(menu.isSelected(0)).thenReturn(false);
        menuViewer.draw(gui, 10L);
        verify(gui).cls();
        verify(gui, atLeastOnce()).drawPixel(anyInt(), anyInt(), any(TextColor.RGB.class));
    ...
    @Test
    public void testDrawAfterAnimation() throws IOException {
        when(menu.isSelected(0)).thenReturn(false);
    ...
    @Test
    public void testDrawAfterAnimationisSelected() throws IOException {
    ...
    @Test
    public void testDrawAfterAnimationisSelected80isVisible() throws IOException {
        when(menu.isSelected(0)).thenReturn(true);
    ...
    @Test
    public void testDrawAfterAnimationisSelected80() throws IOException {
        when(menu.isSelected(0)).thenReturn(true);
        when(menu.getInGame()).thenReturn(true);
