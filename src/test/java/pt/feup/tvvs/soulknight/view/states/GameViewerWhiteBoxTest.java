...
public class GameViewerWhiteBoxTest {
    ...
    @Test
    void testDrawWithNull() throws IOException {
    ...
    @Test
    void testDrawFlashActive() throws IOException {
    ...
    @Test
    void testDrawAfterEffectActive() throws IOException {
