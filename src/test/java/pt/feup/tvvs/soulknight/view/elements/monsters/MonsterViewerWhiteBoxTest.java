...
public class MonsterViewerWhiteBoxTest {
    ...
    @Test
    void testDrawSwordMonsterAnimation() throws IOException {
    ...
    @Test
    void testDrawMinhoteMonster() throws IOException {
        enemy = mock(Enemies.class);
    ...
    @Test
    void testDrawUnknownMonsterThrowsException() {
        enemy = mock(Enemies.class);
    ...
    @Test
    void testGetSpriteForAnimationReturnsCorrectFrame() {
