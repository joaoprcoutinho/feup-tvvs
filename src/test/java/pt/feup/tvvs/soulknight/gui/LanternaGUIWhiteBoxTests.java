...
public class LanternaGUIWhiteBoxTests {
    ...
    @Test
    public void testGetActionNull() throws IOException {
        assertEquals(GUI.ACTION.NULL, gui.getACTION());
    }

    @Test
    public void testKeyActions() throws IOException {
    ...
    @Test
    public void testKeyReleaseSpamKey() throws IOException {
        KeyAdapter adapter = gui.getKeyAdapter();
    ...
    @Test
    public void testKeyReleaseNoSpamKey() throws IOException {
        KeyAdapter adapter = gui.getKeyAdapter();
    ...
    @Test
    public void testResolutionScale() throws IOException, URISyntaxException, FontFormatException {
