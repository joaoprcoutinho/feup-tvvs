...
public class SceneControllerWhiteBoxTests {
    private Scene scene;
    ...
    @Test
    public void testMoveEnd() throws IOException{
    ...
    @Test
    public void testMoveFinal() throws IOException {
        when(scene.isAtEndPosition()).thenReturn(true);
        when(knight.getOrbs()).thenReturn(3);
        when(scene.getSceneID()).thenReturn(0);
    ...
    @Test
    public void testMoveQuit() throws IOException {
