...
public class SettingsMenuControllerWhiteBoxTest {
    ...
    @Test
    void testMoveUp() throws IOException, URISyntaxException, FontFormatException {
    ...
    @Test
    void testMoveDown() throws IOException, URISyntaxException, FontFormatException {
    ...
    @Test
    void testMoveQuit() throws IOException, URISyntaxException, FontFormatException {
        controller.move(game, GUI.ACTION.QUIT, 0);
        verify(particleMenuController).move(game, GUI.ACTION.QUIT, 0);
    }

    @Test
    void testMoveDefault() throws IOException, URISyntaxException, FontFormatException {
